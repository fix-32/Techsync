...
cmd({
    ...
    category: "utility",
    use: ".currency amount fromCurrency toCurrency (e.g: .convert 100 USD RANDS)",
    filename: __filename,
}, async (conn, mek, msg, { from, reply, args }) => {
    try {
        if (args.length !== 3) {
            return reply("*⭕ ɪɴᴠᴀʟɪᴅ Fᴏʀᴍᴀᴛ! ᴜsᴇ: .ᴄᴜʀʀᴇɴᴄʏ ᴀᴍᴏᴜɴᴛ Fʀᴏᴍ ᴄᴜʀʀᴇɴᴄʏ ᴛᴏᴄᴜʀʀᴇɴᴄʏ*\n*ᴇxᴀᴍᴘʟᴇ: .ᴄᴜʀʀᴇɴᴄʏ 𝟷𝟶𝟶 ᴜsᴅ ʀᴀɴᴅs*");
        }
        ...
        const message = `*🌍 ᴛᴇᴄʜsʏɴᴄ-ᴍᴅ ᴄᴜʀʀᴇɴᴄʏ ᴄᴏɴᴠᴇʀsɪᴏɴ 💵*\n\n` +
            `*💲 Fʀᴏᴍ:* ${formattedAmount} ${fromCurrency}\n` +
